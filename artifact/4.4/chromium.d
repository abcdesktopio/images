...
# Dockerfile chromium is generated at Wed Jul 01 2026 02:06:42 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64,linux/arm64
#
ARG TAG=4.4
FROM ghcr.io/abcdesktopio/oc.template.debian:$TAG
USER root
# Install package
RUN echo 'debconf debconf/frontend select Noninteractive' | debconf-set-selections
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y chromium && apt-get clean && rm -rf /var/lib/apt/lists/* 
...
LABEL oc.template="ghcr.io/abcdesktopio/oc.template.debian"
ENV ARGS="--no-default-browser-check"
...
LABEL oc.args="--no-default-browser-check"
#
