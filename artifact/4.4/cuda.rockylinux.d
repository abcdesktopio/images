...
# Dockerfile cuda.rockylinux is generated at Sun Jun 28 2026 02:06:36 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64
#
ARG TAG=4.4
FROM ghcr.io/abcdesktopio/oc.template.rockylinux.nvidia.8:$TAG
USER root
# Install package
RUN dnf install -y gnome-terminal sudo procps dbus-x11 mesa-dri-drivers mesa-libGL google-noto-fonts-common xorg-x11-fonts-100dpi xorg-x11-fonts-75dpi gnome-font-viewer liberation-fonts-common && dnf -y clean all && rm -rf /var/cache
...
LABEL oc.keyword="cuda.rockylinux,cuda nvidia rockylinux terminal"
LABEL oc.cat="development"
LABEL oc.desktopfile="org.gnome.Terminal.desktop"
LABEL oc.launch="gnome-terminal-server.Gnome-terminal"
LABEL oc.template="ghcr.io/abcdesktopio/oc.template.rockylinux.nvidia.8"
ENV ARGS="--wait"
