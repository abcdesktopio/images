...
# Dockerfile winhelp-wine is generated at Thu Jun 11 2026 14:47:43 GMT+0000 (Coordinated Universal Time)
...
RUN mv /composer/.wine /composer/.wine.seed
ENV WINEPREFIX=/tmp/.wine
RUN printf '#!/bin/sh\n[ -d $WINEPREFIX ] || cp -r /composer/.wine.seed $WINEPREFIX\nexec /usr/bin/wine $@\n' > /usr/local/bin/wine-seed.sh && chmod +x /usr/local/bin/wine-seed.sh
# Install package
...
LABEL oc.path="/usr/local/bin/wine-seed.sh"
...
ENV APP="/usr/local/bin/wine-seed.sh"
