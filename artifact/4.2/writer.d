...
# Dockerfile writer is generated at Mon Jan 26 2026 00:56:14 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64,linux/arm64
#
ARG TAG=4.2
FROM ghcr.io/abcdesktopio/oc.template.ubuntu.libreoffice:$TAG
USER root
ENV ABCDESKTOP_LOCALACCOUNT_DIR=/etc/localaccount
# Install package
RUN echo 'debconf debconf/frontend select Noninteractive' | debconf-set-selections
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y  --no-install-recommends libreoffice-writer && apt-get clean && rm -rf /var/lib/apt/lists/* 
...
LABEL oc.template="ghcr.io/abcdesktopio/oc.template.ubuntu.libreoffice"
ENV ARGS="--writer"
LABEL oc.name="writer"
LABEL oc.displayname="Writer ubuntu"
LABEL oc.path="/usr/bin/libreoffice"
LABEL oc.type=app
...
ENV APPNAME="writer"
ENV APPBIN="/usr/bin/libreoffice"
# ENV APP is deprecated, removed in next release
ENV APP="/usr/bin/libreoffice"
