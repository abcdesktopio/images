...
# Dockerfile xman is generated at Wed Dec 24 2025 00:49:16 GMT+0000 (Coordinated Universal Time)
# platforms=linux/amd64,linux/arm64
#
ARG TAG=4.2
FROM ghcr.io/abcdesktopio/oc.template.ubuntu.minimal.18.04:$TAG
USER root
ENV ABCDESKTOP_LOCALACCOUNT_DIR=/etc/localaccount
# Install package
RUN echo 'debconf debconf/frontend select Noninteractive' | debconf-set-selections
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get install -y  --no-install-recommends x11-apps man-db manpages manpages-posix manpages-dev manpages-posix-dev && apt-get clean && rm -rf /var/lib/apt/lists/* 
...
LABEL oc.template="ghcr.io/abcdesktopio/oc.template.ubuntu.minimal.18.04"
LABEL oc.name="xman"
